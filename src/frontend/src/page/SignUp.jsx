                ...
                <div style={{ 
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', width: '300px' }}>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                            ...
                            <input type="text" placeholder="How should we call you?" style={inputStyle} />
                        </div>

                        <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                            <label style={{ fontSize: '14px', fontWeight: '500', color: '#333' }}>Email Address</label>
                            <input type="email" placeholder="Peter@example.com" style={inputStyle} required />
                        </div>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                            ...
                            <div style={{ position: 'relative', width: '100%' }}>
                                <input 
                                    ...
                                    placeholder="The password should be longer than 9 characters" 
